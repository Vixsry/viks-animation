...
class Viks3D {
  ...
  init() {
    // Searches for all elements with the data-viks="3D" attribute
    this.elements = document.querySelectorAll('[data-viks="3D"]');
    this.setupAnimations();
  ...
  // Methods for adding shadow effects
  addShadow() {
    this.elements.forEach(element => {
  ...
  // Methods for adding parallax effects
